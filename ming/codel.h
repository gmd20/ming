// https://github.com/facebook/wangle/blob/master/wangle/concurrent/Codel.h
// http://lxr.free-electrons.com/source/include/net/codel_impl.h
...
class Codel {
 ...
 public:
  // Facebook default values( codel_interval_ = 100, codel_target_delay_ = 5)
  explicit Codel(int32_t codel_interval, int32_t codel_target_delay);
 ...
 private:
  ...
  // Facebook default values( codel_interval_ = 100, codel_target_delay_ = 5)
  int32_t codel_interval_; // Codel default interval time in ms.
  int32_t codel_target_delay_; // Target codel queueing delay in ms.
};
